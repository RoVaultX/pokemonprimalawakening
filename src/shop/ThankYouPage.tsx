...
const DISCORD_INVITE = "https://discord.gg/robloxbrickbronze";
const DISCORD_WIDGET_ID = "1203364790400057354";
          ...
          <div className="site-brand">
            ...
            <div>
              ...
              <p className="helper-text">
                <Link to="/home">← Back to Primal Awakening site</Link>
              </p>
            </div>
          </div>
        </div>
      ...
      <section>
        ...
        <ul className="post-purchase-list">
          ...
          <li className="helper-text">
            A link to a Roblox item we can purchase from you (preferably a gamepass that you own)
          </li>
        </ul>
      </section>
